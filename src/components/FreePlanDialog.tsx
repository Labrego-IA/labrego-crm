  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white dark:bg-surface-dark rounded-2xl shadow-2xl w-full max-w-md m-4 p-8 text-center animate-in zoom-in-95 fade-in duration-200">
        {/* Warning icon */}
        ...
        <div className="flex items-center justify-center gap-3">
          <button
            onClick={onClose}
            className="px-5 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-white/10 hover:bg-slate-200 rounded-xl transition-colors"
          >
            Fechar
          </button>
          <button
