...
const SYSTEM_TEMPLATES: Omit<EmailTemplate, 'orgId' | 'createdAt' | 'updatedAt' | 'createdBy' | 'createdByName'>[] = [
  {
    ...
    isSystem: true,
    blocks: [
      b('bv1', 'image', { src: 'https://placehold.co/600x200/EA580C/FFF?text=Bem-vindo!', alt: 'Banner', align: 'center', imageWidth: 600, paddingBottom: 0 }),
      ...
      b('bv4', 'button', { buttonText: 'Começar agora', buttonUrl: 'https://', buttonColor: '#EA580C', buttonTextColor: '#FFFFFF', align: 'center', paddingTop: 8 }),
  ...
  },
  {
    ...
    blocks: [
      ...
      b('fu4', 'button', { buttonText: 'Agendar reunião', buttonUrl: 'https://', buttonColor: '#EA580C', buttonTextColor: '#FFFFFF', align: 'center', paddingTop: 8 }),
  ...
  },
  {
    ...
    blocks: [
      ...
      b('in2', 'divider', { dividerColor: '#EA580C', dividerThickness: 3, paddingTop: 8, paddingBottom: 16 }),
      ...
      b('in6', 'button', { buttonText: 'Saiba mais', buttonUrl: 'https://', buttonColor: '#EA580C', buttonTextColor: '#FFFFFF', align: 'center', paddingTop: 8 }),
