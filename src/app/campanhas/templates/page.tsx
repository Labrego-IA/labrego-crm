...
const SYSTEM_TEMPLATES: Omit<EmailTemplate, 'orgId' | 'createdAt' | 'updatedAt' | 'createdBy' | 'createdByName'>[] = [
  {
    ...
    blocks: [
      ...
      b('bv4', 'button', { buttonText: 'Começar agora', buttonUrl: 'https://', buttonColor: '#06B6D4', buttonTextColor: '#FFFFFF', align: 'center', paddingTop: 8 }),
  ...
  },
  {
    ...
    blocks: [
      ...
      b('fu4', 'button', { buttonText: 'Agendar reunião', buttonUrl: 'https://', buttonColor: '#06B6D4', buttonTextColor: '#FFFFFF', align: 'center', paddingTop: 8 }),
  ...
  },
  {
    ...
    blocks: [
      ...
      b('in2', 'divider', { dividerColor: '#06B6D4', dividerThickness: 3, paddingTop: 8, paddingBottom: 16 }),
      ...
      b('in6', 'button', { buttonText: 'Saiba mais', buttonUrl: 'https://', buttonColor: '#06B6D4', buttonTextColor: '#FFFFFF', align: 'center', paddingTop: 8 }),
