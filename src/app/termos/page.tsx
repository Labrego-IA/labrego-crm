  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-sm text-slate-600 leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">1. Aceite dos Termos</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">2. Descricao do Servico</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">3. Conta e Responsabilidade</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">4. Uso Aceitavel</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">5. Agentes de IA</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">6. Planos e Pagamento</h2>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">7. Propriedade Intelectual</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">8. Limitacao de Responsabilidade</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">9. Contato</h2>
        <p>
