export default function PrivacidadePage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold text-slate-800 dark:text-white mb-8">Politica de Privacidade</h1>
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">1. Coleta de Dados</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">2. Uso dos Dados</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">3. Agentes de IA e Processamento</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">4. Compartilhamento de Dados</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">5. Seguranca</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">6. Seus Direitos (LGPD)</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">7. Retencao de Dados</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-slate-800 dark:text-white mt-8">8. Contato</h2>
        <p>
