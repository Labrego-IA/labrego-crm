            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  {isCurrent && (
                    <span className="text-[10px] font-semibold uppercase tracking-wider text-primary-600 bg-primary-100 px-2 py-0.5 rounded-full">
                      Atual
                    </span>
                  )}
                </div>
                ...
                <div className="mt-3 space-y-1 text-xs text-slate-600">
                  <p>{planLimits.maxUsers} usuários</p>
                  <p>{planLimits.maxContacts.toLocaleString('pt-BR')} contatos</p>
                  <p>{planLimits.monthlyMinutes.toLocaleString('pt-BR')} min/mês</p>
                </div>
                {!isCurrent && (
                  <button
