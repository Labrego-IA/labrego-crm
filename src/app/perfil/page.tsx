      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <InfoField label="Plano" value={orgPlan ? orgPlan.charAt(0).toUpperCase() + orgPlan.slice(1) : '--'} />
          ...
          {!showDeleteConfirm ? (
            ...
            <div className="space-y-3 p-4 bg-red-50/50 rounded-xl border border-red-100">
              ...
              <input
                ...
                className="w-full rounded-xl border border-red-200 bg-white px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-400 transition-all"
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-red-600 hover:bg-red-700 transition-colors disabled:opacity-50"
                >
                  {deleting ? (
                    <>
                      <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
