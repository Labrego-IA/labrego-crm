    ...
    <div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto mx-4">
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex items-center gap-3 pt-2 border-t border-neutral-100">
                ...
                >
                  <span
                    className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white dark:bg-surface-dark rounded-full shadow transition-transform ${
