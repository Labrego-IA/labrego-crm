        ...
        <div className="px-6 pb-6 border-t border-slate-100 pt-4 space-y-5">
          {loading ? (
            ...
            <>
              {/* Primary provider */}
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Provedor primário</label>
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Se o provedor primário falhar, o email será enviado pelo fallback</p>
              </div>
              ...
              {(config.primaryProvider === 'gmail' || config.fallbackProvider === 'gmail') && (
                <div className="space-y-3 p-4 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <p className="text-xs text-slate-400">
                    Use uma <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener noreferrer" className="text-primary-500 underline hover:text-primary-600">Senha de App do Google</a> (requer verificação em duas etapas). Não use sua senha normal.
                  </p>
                </div>
              )}
